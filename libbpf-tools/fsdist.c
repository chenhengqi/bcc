...
static const char *fs_name = "ext4";
...
"Summarize btrfs/ext4/nfs/xfs operation latency.\n"
"\n"
"Usage: fsdist [-h] [-x] [-T] [-m] [-p PID] [interval] [count]\n"
"\n"
"EXAMPLES:\n"
"    fsdist                     # show ext4 operation latency as a histogram\n"
...
static const struct argp_option opts[] = {
	...
	{ "fs", 'x', "Filesystem", 0, "Which filesystem to trace, [btrfs/ext4/nfs/xfs]" },
